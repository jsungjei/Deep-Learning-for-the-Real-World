...
def sgd_optimization_mnist_climin(optimizer_type, n_epochs=10,
    ...
    best_W = validation_score_info[3][0:classifier.n_in * classifier.n_out].reshape((classifier.n_in, classifier.n_out))
...
if __name__ == '__main__':
    ...
    #                       rmsprop                             -> rmsprop
    sgd_optimization_mnist_climin(n_epochs=10, batch_size=600, optimizer_type="lbfgs")