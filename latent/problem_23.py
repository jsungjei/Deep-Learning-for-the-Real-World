...
class SparseAutoEncoder(object):
    def __init__(self, num_input, num_hidden, batch_size=20, learning_rate=0.01, sparsity_lambda=0.01, n_epochs=1, reconstruction_cost="cross_entropy", sparsity_cost = "kl"):
...
if __name__ == '__main__':
    ...
    SqAE = SparseAutoEncoder(num_input=28 * 28, num_hidden=500)
    data_loader = load_data()

    datasets = data_loader.load_mnist_data()
