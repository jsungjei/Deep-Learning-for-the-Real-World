...
def test_mlp(activator_type, learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=200,
             dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, momentum_coeff=0.):
    """
    ...
    plt.plot(epochs, trainings, 'g', epochs, validations, 'r', epochs, tests, 'b')
    ...
    img_name = 'error_'+activator_type + '_500.png'
